...
2. 残留ライン（ME順位・MM点数・WE1基準）を**AJOCC公式で確認**して置換。
   > **【2026-08-29申し送り→2026-08-29対応済み】**
   > 2026-27シーズンの残留ライン新値・系統横断残留判定・連動降格は
   > `season-rules-2026-27`spec のtasks 2〜4として実装済み。
   > **次年度（2027年3月）の降格作業は、本ファイルではなく
   > `.kiro/specs/season-rules-2026-27/runbook.md`（2026-27版）を参照すること。**
   > 本ファイル（rider-demotion-2025-26版）は2025-26シーズン限りの判定資産として変更せず
   > 保持する。
